...
4. [已完成第一步] 建立文件型 Ren'Py golden corpus manifest 和 4 个仓库自有合成 fixture；四个 fixture 均通过 Ren'Py SDK 8.5.3 编译（退出码 0、无 traceback）。后续仍需使用真实中文术语表，完成主菜单、对白、分支、存档和设置页面的截图回归。
